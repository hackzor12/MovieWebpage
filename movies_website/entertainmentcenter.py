...
mrNobody = media.Movie("Mr. Nobody", 
	...
	" Should he go with his mother or stay with his father? Infinite possibilities"
...
darjeelingLimited = media.Movie("Darjeeling Limited", 
	"A year after their father's funeral, three brothers travel across India by"
...
cosmopolis = media.Movie("Cosmopolis", 
	"Riding across Manhattan in a stretch limo in order to get a haircut, a"
	" 28-year-old billionaire asset manager's day devolves into an odyssey with a"
	" cast of characters that start to tear his world apart.", 
	"https://upload.wikimedia.org/wikipedia/en/thumb/a/ad/Cosmopolis_Poster.jpg/220px"
...
fury = media.Movie("Fury",
 ...
 "https://images-na.ssl-images-amazon.com/images/M/MV5BMjA4MDU0NTUyN15BMl5BanBnXkF"
 "tZTgwMzQxMzY4MjE@._V1_UY1200_CR90,0,630,1200_AL_.jpg", 
...
donnieDarko = media.Movie("Donnie Darko", 
	...
	" manipulates him to commit a series of crimes, after he narrowly escapes a" 
	" bizarre accident.",
...
theBigLebowski = media.Movie("The Big Lebowski", 
 "\"The Dude\" Lebowski, mistaken for a millionaire Lebowski, seeks restitution"
 " for his ruined rug and enlists his bowling buddies to help get it.",
 "https://resizing.flixster.com/HnvdNWu_ezMpAlQOqBnsLJG93Mw=/206x305/v1.bTsxMTE3Nz"
 "cxNztqOzE3MzE5OzEyMDA7ODAwOzEyMDA", 
